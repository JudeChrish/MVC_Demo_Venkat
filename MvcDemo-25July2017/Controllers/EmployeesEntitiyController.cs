...
{
    public class EmployeesEntitiyController : Controller
    {
        private EntitiesContext db = new EntitiesContext();

        // GET: EmployeesEntitiy
        ...
        // GET: EmployeesEntitiy/Details/5
        ...
        // POST: EmployeesEntitiy/Delete/5
